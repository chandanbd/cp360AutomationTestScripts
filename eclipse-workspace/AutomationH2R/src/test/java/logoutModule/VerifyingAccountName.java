...
public class VerifyingAccountName {
	...
	public static void main(String[] args) {
		...
		String actualAccountname = driver.findElement(By.xpath("//h6[text()='Chandan B D']")).getText(); //Fetching the account  name

		String expectedAccountname = "Chandan B D";
