...
public class ViewRequests {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//button[text()='View Requests']")).click();

		String actualtitle = driver.findElement(By.xpath("//h4[text()='Attendance Requests Approver-1']")).getText(); // Fetching the warning message

		System.out.println(actualtitle);

		String expectedtitle = "Attendance Requests Approver-1";
