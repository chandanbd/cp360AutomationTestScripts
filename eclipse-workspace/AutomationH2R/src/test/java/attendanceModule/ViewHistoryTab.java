...
public class ViewHistoryTab {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//tbody/tr[5]/td[8]/button[1]")).click();
		
		driver.findElement(By.xpath("//button[text()='Close']")).click();
		
		String actualtitle = driver.findElement(By.xpath("//h4[text()='Attendance Requests History']")).getText(); // Fetching the warning message

		System.out.println(actualtitle);

		String expectedtitle = "Attendance Requests History";
