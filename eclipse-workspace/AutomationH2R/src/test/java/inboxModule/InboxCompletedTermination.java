...
public class InboxCompletedTermination {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//li[normalize-space()='Termination(101)']")).click();
		...
		String actualtitle = driver.findElement(By.xpath("//h2[text()='Termination Request']")).getText(); //  Fetching the warning message


		System.out.println(actualtitle);
		String expectedtitle = "Termination Request";
