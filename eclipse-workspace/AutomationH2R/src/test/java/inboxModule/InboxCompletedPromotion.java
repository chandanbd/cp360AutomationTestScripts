...
public class InboxCompletedPromotion {

	public static void main(String[] args) {
		// TODO Auto-generated method stub

		//TEST Passed with Chrome and Edge
		...
		driver.findElement(By.xpath("//li[normalize-space()='Promotion(83)']")).click(); // Click on Promotion Tab
		...
		String actualtitle = driver.findElement(By.xpath("//h2[text()='Promotion Update']")).getText(); //  Fetching the Title


		System.out.println(actualtitle);
		String expectedtitle = "Promotion Update"; // Verifying the tittle
		...
		driver.findElement(By.xpath("//button[text()='Close']")).click(); // Click on Close tab
