...
public class InboxCompletedTimeoff {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//button[normalize-space()='Time Off(253)']")).click();

		driver.findElement(By.xpath("(//button[@type='button'][normalize-space()='Cancelled'])[1]")).click();

		//(//h2[normalize-space()='Time off Request'])[1]

		String actualtitle = driver.findElement(By.xpath("(//h2[normalize-space()='Time off Request'])[1]")).getText(); //  Fetching the warning message

		String expectedtitle = "Time off Request";
