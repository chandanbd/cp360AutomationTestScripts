...
public class ManagingWidgetsFunctionality {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//button[text()='Manage Widgets']")).click();

		driver.findElement(By.xpath("//p[normalize-space()='View Announcements']")).click();
		
        driver.findElement(By.xpath("//p[normalize-space()='View Links']")).click();
