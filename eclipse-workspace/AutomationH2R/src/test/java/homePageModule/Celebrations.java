...
public class Celebrations {
	...
	public static void main(String[] args) {
		...
		//driver.findElement(By.xpath("//h6[normalize-space()='Naresh Kondemoni Yadav']")).click();
		

		WebDriverWait wait = new WebDriverWait(driver, 30); 
		WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//h6[normalize-space()='Naresh Kondemoni Yadav']")));
		element.click(); // going to another tab and again asking for email and password
