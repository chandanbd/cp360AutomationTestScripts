...
public class EmployeesGeography {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("(//*[name()='svg'][@role='img'])[30]")).click(); // Clicking on EmployeesGeography

		Thread.sleep(3000); // Wait for 3 Seconds

		//JavascriptExecutor js = (JavascriptExecutor)driver;  // To scroll down the page
