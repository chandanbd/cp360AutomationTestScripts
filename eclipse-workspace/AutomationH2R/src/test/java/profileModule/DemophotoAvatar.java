...
public class DemophotoAvatar {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//input[@placeholder='Search employees']")).sendKeys("alok patel");
		...
		WebElement element = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//img)[6]")));
		element.click();
