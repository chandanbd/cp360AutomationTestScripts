...
public class CompanylinksEditcategory {
	...
	public static void main(String[] args) {
		...
		//WebDriverManager.edgedriver().setup();
				...
				driver.findElement(By.xpath("//body//div//div[@data-simplebar='init']//div//div//div//div//div//div//div//div//div//div[1]//div[1]//div[1]//div[2]//button[1]")).click();
				
				driver.findElement(By.xpath("//input[@name='category']")).sendKeys("23");
				...
				String expectedsuccessfulmessage = "Category Updated successfully";

				if(successfulmessage.contains(expectedsuccessfulmessage))
				{
					System.out.println("Test passed! Category Updated successfully");
				}
				else
				{
					System.out.println("Test failed! Category not Updated successfully");
				}
