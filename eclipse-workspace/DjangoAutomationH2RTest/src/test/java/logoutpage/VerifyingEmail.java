...
public class VerifyingEmail {
	...
	public static void main(String[] args) {
		...
		String actualAccountEmailname = driver.findElement(By.xpath("//p[normalize-space()='admin@o2ohrms.com']")).getText(); //Fetching the account Email name
		
		System.out.println(actualAccountEmailname);

		String expectedAccountEmailname = "admin@o2ohrms.com";
